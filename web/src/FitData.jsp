        ...
        <div class="container">
            ...
            <div class="user-menu">
                <div class="user-avatar">
                    <img src="C:\Users\chris\Phylix\Phylix\web\src\perfil.png" alt="Usuario">
                </div>
        ...
        <section class="profile-header">
            <div class="container">
                ...
                <div class="quick-stats">
                    <div class="stat-card">
                        <div class="stat-icon">
                            <img src="dias_activo.png" alt="Días">
                        </div>
                        <div class="stat-info">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon">
                            <img src="perdida_peso.png" alt="Peso">
                        </div>
                        <div class="stat-info">
                    ...
                    <div class="stat-card">
                        <div class="stat-icon">
                            <img src="entrenamientos.png" alt="Entrenamientos">
                        </div>
                        <div class="stat-info">
            ...
            <div class="container">
                <div class="dashboard-grid">
                    ...
                    <div class="dashboard-card workout-card">
                        ...
                        <div class="today-workout">
                            ...
                            <div class="workout-actions">
                                <a href="rutina-detalle.jsp" class="btn btn-primary">Iniciar Entrenamiento</a>
                                <a href="MisRutinas.java" class="btn btn-secondary">Ver Todas las Rutinas</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="dashboard-card diet-card">
                        ...
                        <a href="MisDietas.java" class="btn btn-secondary">Ver Plan Completo</a>
                    </div>
                    ...
                    <div class="dashboard-card muscles-card">
                        ...
                        <div class="muscle-groups">
                            <div class="muscle-map">
                                <img src="images/muscle-map.svg" alt="Mapa muscular">
