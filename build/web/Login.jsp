            ...
            <div class="form-container sign-up-container">
                <form action="Registro" method="post" id="signupForm">
                    ...
                    <div class="input-container">
                        <input type="password" id="pswd1" name="pswd1" placeholder="Contraseña" required 
                    ...
                    <div class="password-requirements" id="password-requirements">
                        <ul>
                            <li>Mínimo 12 caracteres, sin espacios. Al menos una letra mayúscula, una minúscula y un número.</li>
                        </ul>
                    </div>
