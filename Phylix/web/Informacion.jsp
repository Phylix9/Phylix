<%-- 
    ...
    Created on : Nov 4, 2024, 10:48:17 AM
    Author     : Abraham
--%>
...
<body>
            ...
            <div class="calculator-container">
                <div class="calculator-form">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="height" min="1" max="2.5" step="0.01">
                    </div>
    ...
    <script>
        ...
        function initGauge() {
            const constante = document.getElementById('imcGauge').getContext('2d');
            imcGauge = new Chart(constante, {
                type: 'doughnut',
                data: {
                    datasets: [{
                    data: [1],
