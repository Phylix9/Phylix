...
<body>
    <div class="sidebar">
        ...
        <a href="MisDietas"><i data-lucide="cookie"></i> Mis Estadísticas</a>
        <a href="CrearRutina"><i data-lucide="dumbbell"></i> Mi progreso semanal</a>
        <a href="Eliminarrutina.jsp"><i data-lucide="person-standing"></i> Mi aprovechamiento de la app</a>
        <a href="Avance"><i data-lucide="user-round-pen"></i> Mi avance </a>
        <a href="Logout"><i data-lucide="log-out"></i> Predicción de mi avance</a>
    </div>
